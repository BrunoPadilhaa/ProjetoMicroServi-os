...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Rafael\Ipl\fonte\python-data\XptoTracking-DataMS\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Rafael\Ipl\fonte\python-data\XptoTracking-DataMS\venv\Scripts\deactivate.nu'
